...
class MPFac extends PluginBase implements Listener {
	...
	public function onEnable() {
        ...
        $this->db->exec("CREATE TABLE IF NOT EXISTS fpower(faction TEXT PRIMARY KEY, pow INT);");
        $this->db->exec("CREATE TABLE IF NOT EXISTS ppower(player TEXT PRIMARY KEY, pow INT);");
        $this->db->exec("CREATE TABLE IF NOT EXISTS fmoney(faction TEXT PRIMARY KEY, pow INT);");
        $this->db->exec("CREATE TABLE IF NOT EXISTS pmoney(player TEXT PRIMARY KEY, pow INT);");
        $this->db->exec("CREATE TABLE IF NOT EXISTS fpower(faction TEXT PRIMARY KEY, pow INT);");
        $this->db->exec("CREATE TABLE IF NOT EXISTS fperm(player TEXT PRIMARY KEY, pow INT);");
	}
...
##########################################################################################################################	
	public function cplotName($player) {
        $x = $player->getFloorX();
		$z = $player->getFloorZ();
	...
	public function formatMessage($string, $confirm = false) {
		if($confirm) {
			return "[" . TextFormat::BLUE . "MPFac" . TextFormat::WHITE . "] " . TextFormat::GREEN . "$string";
		} else {	
			return "[" . TextFormat::BLUE . "MPFac" . TextFormat::WHITE . "] " . TextFormat::RED . "$string";
		}
	}
